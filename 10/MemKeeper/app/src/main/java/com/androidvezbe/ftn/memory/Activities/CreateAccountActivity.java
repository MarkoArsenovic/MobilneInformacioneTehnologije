...
public class CreateAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseStorage = FirebaseStorage.getInstance().getReference().child("MMemory_Profile_Pics");
    ...
    private void createNewAccount() {
        ...
        if (!TextUtils.isEmpty(name) && !TextUtils.isEmpty(lname)
            ...
            mProgressDialog.setMessage("Kreiranje naloga...");
                    ...
                    .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                        ...
                        public void onSuccess(AuthResult authResult) {
                            if (authResult != null) {
                                ...
                                StorageReference imagePath = mFirebaseStorage.child("MMemory_Profile_Pics")
